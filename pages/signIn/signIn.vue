<template>
	<view class="container">
		<view class="content">
			...
			<button class="mini-btn" type="primary" @click="submit">登录</button>		
			<router-link class="goIndex" to="/pages/index/index">前往注册</router-link>
		</view>
	</view>
</template>
		...
		methods: {
			...
			submit() {
				this.$refs.form.validate().then(res=>{
					...
					uni.request({
						url:`http://10.89.136.99:5050/user/login`,
						method:'POST',
						data:res,
						...
						success:res=>{
							...
							if (res.data.code != 200){
								...
								setTimeout('uni.navigateTo({url:"/pages/table/table"})',500)
							}
